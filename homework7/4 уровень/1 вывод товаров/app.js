...
function clickHandler(event) {
    ...
    showCategory(products[event.target.getAttribute('data-type')]);
}
...
function showCategory(category) {
    for (let el of category) {
        myDiv.insertAdjacentHTML('beforeend', getProductMarkup(el));
    }
...
const myDiv = document.querySelector('.products');
